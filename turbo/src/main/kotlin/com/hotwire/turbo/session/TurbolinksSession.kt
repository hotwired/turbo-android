...
import com.hotwire.turbo.config.screenshotsEnabled
import com.hotwire.turbo.http.TurbolinksHttpClient
import com.hotwire.turbo.http.TurbolinksHttpRepository
import com.hotwire.turbo.http.TurbolinksOfflineRequestHandler
import com.hotwire.turbo.http.TurbolinksPreCacheRequest
import com.hotwire.turbo.util.TurbolinksLog
import com.hotwire.turbo.util.coroutineScope
import com.hotwire.turbo.util.runOnUiThread
import com.hotwire.turbo.util.toJson
import com.hotwire.turbo.util.*
import com.hotwire.turbo.views.TurbolinksWebView
import com.hotwire.turbo.visit.TurbolinksVisit
import com.hotwire.turbo.visit.TurbolinksVisitAction
...
class TurbolinksSession private constructor(internal val sessionName: String, internal val activity: Activity, val webView: TurbolinksWebView) {
    ...
    private fun logEvent(event: String, vararg params: Pair<String, Any>) {
        ...
        com.hotwire.turbo.util.logEvent(event, attributes)
    }
